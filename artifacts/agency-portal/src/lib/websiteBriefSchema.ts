...
export const WEBSITE_BRIEF_SECTIONS: WBSection[] = [
  {
    ...
    fields: [
      { key: "obiettivo_sito", label: "A cosa serve il tuo sito?", type: "multi_choice",
        help: "Puoi sceglierne più di una: il sito può fare tante cose insieme.",
        options: [
          { v: "Vendere video-corsi", d: "Il sito è anche un negozio di corsi online" },
          { v: "Farmi trovare in zona", d: "Chi cerca in zona ti trova su Google" },
          { v: "Prendere prenotazioni e contatti", d: "Le clienti ti scrivono o prenotano" },
          { v: "Raccontare il mio brand", d: "La tua storia, il tuo stile, la tua identità" },
          { v: "Vendere eventi e formazione", d: "Iscrizioni a corsi ed eventi dal vivo" },
        ] },
      { key: "azione_visitatore", label: "Cosa vuoi che faccia chi arriva sul sito?", type: "multi_choice",
        help: "Puoi sceglierne più di una.",
        options: [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "corsi_accesso", label: "Come si accede ai corsi?", type: "multi_choice",
        help: "Puoi sceglierne più di una (es. alcuni singoli, altri in abbonamento).",
        options: [{ v: "A pagamento singolo" }, { v: "In abbonamento" }, { v: "Gratis con iscrizione" }] },
